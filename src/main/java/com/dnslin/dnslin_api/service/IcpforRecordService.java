 ...
 */
@Service
public class IcpforRecordService {
    /*
     *
     *功能描述
     * @author dnslin
     ...
     * @return
     */
    public String requestToGetToken(String cookie) throws IOException, NoSuchAlgorithmException {
    ...
    *
     ...
     * @return 
     */
    public String initiateRequest(String cookie, String token,String domain) throws IOException {
        ObjectMapper MAPPER = new ObjectMapper();
        HttpClient client = getHttpClient();
        IcpParameter parameter = new IcpParameter();
